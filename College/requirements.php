...
<head>
    ...
    <title>Requirements - College</title>
    ...
    <div class="container">
            ...
            <form class="form" action="../Database/asc_Student.php" method="post" enctype="multipart/form-data">
                ...
                <div class="content requirements">
                    ...
                    <div class="input">
                        <label>G12 Certificate of Recognition</label>
                ...
                <div class="footer">
                    ...
                    <button class="next" type="submit" name="create" value="Submit">Next</button>
                </div>
            </form>
        </div>
