    ...
    <div class="wrapper">
        <aside id="sidebar">
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    <li class="sidebar-header">SUPERADMIN</li>
                    
                    <!-- Analytics -->
                    <li class="sidebar-item">
                        <a onclick="switch_superadmin()" class="sidebar-link">
                    ...
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed" data-bs-target="#one" data-bs-toggle="collapse" aria-expanded="false">
                            <i class="fa-solid fa-gear"></i> GENERAL SETUP
                        </a>
                        <ul id="one" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item" id="dashboard-link"><a onclick="switch_sy()" class="sidebar-link" href="#">School Year</a></li>
                            <li class="sidebar-item"><a onclick="switch_cur()" class="sidebar-link" href="#">Curriculum</a></li> <!--Curriculums, Program, Courses Prerequisites-->
                            <li class="sidebar-item"><a onclick="switch_tui()" class="sidebar-link" href="#">Tuition & Plans</a></li> <!--Tuitions & Plans  Breakdown-->
                            <li class="sidebar-item"><a onclick="switch_curs()" class="sidebar-link" href="#">Set-up Account</a></li>
                        </ul>
                    </li>
                    <!--Registration-->
                    <li class="sidebar-item">
                    ...
                    <!--Payment Tracking-->
                    <li class="sidebar-item">
                        <a href="#" class="sidebar-link collapsed" data-bs-target="#four" data-bs-toggle="collapse" aria-expanded="false">
                            <i class="fa-solid fa-receipt"></i> PAYMENT TRACKING
                        </a>
                        <ul id="four" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <!-- <li class="sidebar-item"><a href="#" onclick="switch_tp()" class="sidebar-link">Tuition & Payment Plans</a></li> -->
                            <li class="sidebar-item"><a href="#" onclick="switch_pv()" class="sidebar-link">Payments Verification</a></li>
                            <li class="sidebar-item"><a href="#" onclick="switch_ts()" class="sidebar-link">Payments Record</a></li>
                            <!-- <li class="sidebar-item"><a href="#" onclick="switch_masA()" class="sidebar-link">MasterLists</a></li> -->
                        </ul>
                    </li>
                </ul>
                <!-- Sidebar Footer -->
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <iframe id="myIframe" width="100%" height="100%" src="../../SAdmin_Statistics.php"></iframe>
            </main>
