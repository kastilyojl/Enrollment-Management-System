...
$(document).ready(function () {
    $('#search-box').on('input', function () {
        ...
        if (query) {
            $.ajax({
                url: '../PROCESS/5_tuition-process-rd.php',
                type: 'GET',
                            ...
                            const tr = `<tr>
                                ...
                                <td>
                                    <form action="../PROCESS/5_tuition-process-rd.php" method="POST" style="display:inline;">
                                        <input type="hidden" name="id" value="${row.t_code}">
                                        <button type="submit" name="update">Edit</button>
                                    </form>
                                    <button type="button" onclick="confirmDelete('${row.t_code}')">Delete</button>
                                </td>
                            </tr>`;
                            tableBody.append(tr);
                        });
    ...
    window.confirmDelete = function (id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = '../PROCESS/5_tuition-process-rd.php';
