...
$prog_codes = [];
$sql = "SELECT prog_code FROM d_program WHERE prog_dept='SHS'";
...
<head>
    ...
    <title>Academic Informatio - SHS</title>
            ...
            <form class="form" action="./parents.php" method="post">
                ...
                <div class="content">
                    ...
                    <div class="input ">
                        ...
                        <input type="radio" name="dept" value="1" checked onclick="return false;"><label>SHS</label>
                        <input type="radio" name="dept" value="" onclick="return false;"><label>College</label>
                    </div>
                    <div class="input">
                    ...
                    <div class="input">
                        ...
                        <input type="radio" value="11" name="yrlevel" <?php echo ($gy_level_value == 11) ? 'checked' : ''; ?> class="<?php echo getErrorClass('yrlevel'); ?>"><label>Grade 11</label>
                        <input type="radio" value="12" name="yrlevel" <?php echo ($gy_level_value == 12) ? 'checked' : ''; ?> class="<?php echo getErrorClass('yrlevel'); ?>"><label>Grade 12</label>
                    </div>
                    ...
                    <div class="input">
                        <label>LRN</label>
                        <input type="text" name="lrn" placeholder="Enter LRN" value="<?php echo $lrn_value; ?>">
                    </div>
                    <div class="input">
                        <label class="required">Others</label><br>
                        <input type="radio" name="voucher" value="SHS Voucher Receipient" <?php echo ($vou_type_value == "SHS Voucher Receipient") ? 'checked' : ''; ?> class="<?php echo getErrorClass('voucher'); ?>"><label>SHS Voucher Receipient</label><br>
                        <input type="radio" name="voucher" value="Non-Voucher Recipient" <?php echo ($vou_type_value == "Non-Voucher Recipient") ? 'checked' : ''; ?> class="<?php echo getErrorClass('voucher'); ?>"><label>Non-Voucer Receipient / Paying</label>
                    </div> 
                    ...
                    <div class="input" hidden>
                        ...
                        <input type="text" name="ESC" id="inputBoxESC" placeholder="Enter ESC Certificate #" value="<?php echo $esc_cert_value; ?>">
                        <input type="radio" onclick="hideShowInputBox('showScholar')"><label>Scholar</label>
                        <input type="text" name="Scholar" id="inputBoxScholar" placeholder="Enter Scholar Name" value="<?php echo $scho_of_value; ?>">
                    </div>   
                    <!-- Remove  -->
